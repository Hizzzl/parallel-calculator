...
// 		id, err := LegacyProcessExpression("1+2")
// 		if err != nil {
...
// 		id, err := LegacyProcessExpression("2 + (1 * 2 - 3 + (10 * 4 - 14))")
// 		if err != nil {
// 			t.Errorf("Ошибка для составного выражения: %v", err)
// 		}
// 		if id == 0 {
...
// 		id, err := LegacyProcessExpression("42")
// 		if err != nil {
...
// 		_, err := LegacyProcessExpression("1+")
// 		if err == nil {
...
// 		// Передаем некорректное выражение (например, лишний оператор)
// 		_, err := LegacyProcessExpression("abcd")
// 		if err == nil {
// 			t.Error("Ожидается ошибка для некорректного выражения")
// 		}
// 	})
