...
3. **get last expression** - получение результата последнего отправленного выражения. Если данный запрос говорит "неверный id". Значит вы не установили окружение переменных.
